			...
			<div id="forum">
				...
				<h1><span class="h1_back"><img src="templates/paperclip/images/backarrow_blank.gif" alt="" /></span>{POST_SUBJECT}</h1>
				...
				<p>{MESSAGE}</p>
				<h2 class="noborder"><input type="submit" name="save" value="{L_SAVE_MSG}" class="button" />
