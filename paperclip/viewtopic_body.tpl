			...
			<div id="forum">
				<h1><span class="h1_back"><a href="{U_VIEW_FORUM}"><img src="templates/paperclip/images/backarrow.gif" alt="" /></a></span><a href="{U_VIEW_TOPIC}">{TOPIC_TITLE}</a></h1>
				{POLL_DISPLAY}
				<!-- BEGIN postrow -->
				...
				<p>{postrow.MESSAGE}<span class="edited">{postrow.EDITED_MESSAGE}</span><br /><br /></p>
				<!-- END postrow -->
