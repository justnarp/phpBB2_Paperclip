			...
			<div id="forum">
				...
				<h1><span class="h1_back"><img src="templates/paperclip/images/backarrow_blank.gif" alt="" /></span>{L_GROUP_MEMBERSHIP_DETAILS}</h1>
				...
				<h1><span class="h1_back"><img src="templates/paperclip/images/backarrow_blank.gif" alt="" /></span>{L_JOIN_A_GROUP}</h1>
				<h2>{L_SELECT_A_GROUP}</h2>
				<form method="get" action="{S_USERGROUP_ACTION}"><p>
