			...
			<div id="forum">
				<h1><span class="h1_back"><img src="templates/paperclip/images/backarrow_blank.gif" alt="" /></span>{PAGE_TITLE}</h1>
				<h2 class="noborder"><a href="javascript:;" tabindex="4" onClick="switchMenu('show_sortmethod');" onMouseOver="window.status=''; return true;" onMouseOut="window.status=''; return true;">{L_SELECT_SORT_METHOD}</a></h2>
				...
				<!-- END memberrow -->
				<h2 class="noborder">{PAGE_NUMBER}<br />{PAGINATION}</h2>
