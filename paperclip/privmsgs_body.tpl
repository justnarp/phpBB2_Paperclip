	...
	function select_switch(status)
	{
		for (i = 0; i < document.privmsg_list.length; i++)
		{
			...
			<div id="forum">
				...
				<h2 class="noborder">{S_HIDDEN_FIELDS}
				...
				<input type="button" tabindex="6" class="button"  name="postreply" value="{PAGE_TITLE}" onclick="window.location.href='{U_POST_NEW_TOPIC}'" />
				</h2>
