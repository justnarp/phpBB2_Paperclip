			...
			<div id="forum">
				<h1><span class="h1_back"><img src="templates/paperclip/images/backarrow_blank.gif" alt="" /></span>{L_VIEWING_PROFILE}</h1>

				<h2>{L_ABOUT_USER}</h2>
							<table cellspacing="0" class="table_details profileviewbody">
								<tr>
									<td>
										<p>
