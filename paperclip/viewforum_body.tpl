			...
			<div id="forum">
				<h1><span class="h1_back"><a href="{U_INDEX}"><img src="templates/paperclip/images/backarrow.gif" alt="" /></a></span><a href="{U_VIEW_FORUM}">{FORUM_NAME}</a></h1>
				<!-- BEGIN topicrow -->
				<h2>{topicrow.TOPIC_FOLDER_IMG}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}">{topicrow.TOPIC_TITLE}</a></h2>
				<p>{L_AUTHOR}: {topicrow.TOPIC_AUTHOR}. {L_REPLIES}: {topicrow.REPLIES}. {L_VIEWS}: {topicrow.VIEWS}.<br />
				{L_LASTPOST}: {topicrow.LAST_POST_TIME} {topicrow.LAST_POST_AUTHOR}.<br />
