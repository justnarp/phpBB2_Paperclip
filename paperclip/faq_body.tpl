			...
			<div id="forum">
				...
				<h1><span class="h1_back"><img src="templates/paperclip/images/backarrow_blank.gif" alt="" /></span>{L_FAQ_TITLE}</h1>
				...
				<!-- BEGIN faq_block -->
				<h1><span class="h1_back"><img src="templates/paperclip/images/backarrow_blank.gif" alt="" /></span>{faq_block.BLOCK_TITLE}</h1>
				<!-- BEGIN faq_row --> 
