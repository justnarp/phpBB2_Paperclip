			...
			<div id="forum">
				...
				<h1><span class="h1_back"><span class="h1_back"><img src="templates/paperclip/images/backarrow_blank.gif" alt="" /></span>{L_REGISTRATION_INFO}</h1>
				<h2 class="noborder"><a href="javascript:;" tabindex="1" onClick="switchMenu('show_profileinfo');" onMouseOver="window.status=''; return true;" onMouseOut="window.status=''; return true;">{L_PROFILE_INFO}</a>
				&nbsp;&nbsp;&nbsp;
				...
				<p>{L_CONFIRM_PASSWORD_EXPLAIN}
				<input type="password" class="post" name="cur_password" maxlength="32" value="{CUR_PASSWORD}" tabindex="52" /></p>
				<!-- END switch_edit_profile -->
				<h2>{L_NEW_PASSWORD} *</h2>
				<p>{L_PASSWORD_IF_CHANGED}
				<input type="password" class="post" name="new_password" maxlength="32" value="{NEW_PASSWORD}" tabindex="53" /></p>
				<h2>{L_CONFIRM_PASSWORD} *</h2>
				<p>{L_PASSWORD_CONFIRM_IF_CHANGED}
				<input type="password" class="post" name="password_confirm" maxlength="32" value="{PASSWORD_CONFIRM}" tabindex="54" /></p>
				<!-- Visual Confirmation -->
				<!-- BEGIN switch_confirm -->
				<h2>{L_CONFIRM_CODE} *</h2>
				<p>{L_CONFIRM_CODE_EXPLAIN}<br />
				{CONFIRM_IMG}<br />
				<input type="text" class="post postshort" name="confirm_code" maxlength="6" value="" tabindex="55" /></p>
				<!-- END switch_confirm -->
