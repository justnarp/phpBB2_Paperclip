...
<form action="{S_POST_ACTION}" method="post" name="post" onsubmit="return checkForm(this)">
			...
			<div id="forum">
				...
				<h1><span class="h1_back"><a href="{U_VIEW_FORUM}"><img src="templates/paperclip/images/backarrow.gif" alt="" /></a></span>{L_POST_A}</h1>
				...
				{ERROR_BOX}
					...
					<div id="show_options" class="show_userdetails" style="display: none;">
						<div class="line_show" style="padding: 10px;">
							...
							&nbsp;&nbsp;&nbsp;
							{L_FONT_SIZE}:
							<select name="addbbcode20" tabindex="17" onChange="bbfontstyle('[size=' + this.form.addbbcode20.options[this.form.addbbcode20.selectedIndex].value + ']', '[/size]');this.selectedIndex=0;" onMouseOver="helpline('f')">
