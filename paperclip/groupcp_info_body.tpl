			...
			<div id="forum">
				<h1><span class="h1_back"><img src="templates/paperclip/images/backarrow_blank.gif" alt="" /></span>{L_GROUP_INFORMATION}</h1>
				<h2>{GROUP_NAME}</h2>
				<p>{GROUP_DESC}</p>
			...
			<form action="{S_GROUPCP_ACTION}" method="post" name="post">
				...
				<!-- END switch_mod_option -->
				<a href="{member_row.U_VIEWPROFILE}">{member_row.USERNAME}</a><br />
				<!-- END member_row -->
