...
<form action="{S_SEARCH_ACTION}" method="POST">
			...
			<div id="forum">
				<h1><span class="h1_back"><img src="templates/paperclip/images/backarrow_blank.gif" alt="" /></span>{L_SEARCH_QUERY}</h1>
				<h2 class="noborder"><a href="javascript:;" tabindex="2" onClick="switchMenu('show_searchoptions');" onMouseOver="window.status=''; return true;" onMouseOut="window.status=''; return true;">{L_SEARCH_OPTIONS}</a></h2>
