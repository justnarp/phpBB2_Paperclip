...
<table width="100%" cellpadding="4" cellspacing="0" border="0" align="center">
  <tr> 
	<td align="center" ><a href="{U_FORUM_INDEX}" target="_parent"><img src="../templates/paperclip/images/logo_phpBB_med.gif" border="0" /></a></td>
  </tr>
  <tr> 
	<td align="center" > 
	  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
		...
		<!-- END catrow -->
        <tr> 
          <td class="catSides"><span class="cattitle">Template Admin</span></td>
        </tr>
        <tr> 
          <td class="row1"><span class="genmed"><a href="http://www.insanerabbit.net/" target="_blank" class="genmed">Paperclip updates</a></span></td>
        </tr>
	  </table>
	</td>
  </tr>
